...
@include('components.breadcrumbs', ['breadcrumbs' => [
    ...
    ['label' => __('product.edit_title'), 'url' => '#'],
]])

    <h2>{{ __('product.edit_title') }}</h2>
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="form-check">
                    <input class="form-check-input @error('storage') is-invalid @enderror"
                           type="radio"
                           name="storage"
                           id="storage-local-edit"
                           value="local"
                           {{ old('storage', 'local') === 'local' ? 'checked' : '' }}>
                    <label class="form-check-label" for="storage-local-edit">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="storage-gcs-edit">
